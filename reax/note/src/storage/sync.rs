...
use crate::accounts::mavinote::{CreateFolderRequest, CreateNoteRequest, MavinoteClient, RespondFolderRequest, RespondRequests, RespondNoteRequest, CreateRequests};
...
pub async fn listen_notifications(account_id: i32) -> Result<Receiver<Option<Error>>, Error> {
    ...
    tokio::spawn(async move {
        ...
        loop {
            ...
            loop {
                ...
                log::debug!("message is received {text}");
            }
        }
    });
